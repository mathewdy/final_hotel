...
<nav aria-label="breadcrumb">
    ...
    <!--filter-->
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="economy.php">Available</a></li>
        <li class="breadcrumb-item"><a href="reserved-economy.php">Reserved</a></li>
...
$query_available_rooms = "SELECT rooms.room_number, rooms.status , room_types.name_of_room,  room_types.image
    ...
    WHERE rooms.status = 'occupied' AND room_types.name_of_room = 'economy'";
        ...
        if(mysqli_num_rows($run_room) > 0){
            ...
            <?php foreach($run_room as $row) {?>
                ...
                <img class="card-img-top" src="<?php echo "./Photos/hotel_rooms/" . $row ['image']?>" alt="economy room">
                    ...
                    <a class="btn btn-primary w-100" href="book-now.php?id=<?php echo $row ['room_number']?>">View</a>
                </div>
    <?php 
        }
    }
