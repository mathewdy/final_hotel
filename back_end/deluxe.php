...
<nav aria-label="breadcrumb">
    ...
    <?php
        ...
        $query_deluxe = "SELECT rooms.id , rooms.room_number,rooms.room_type_id, rooms.status, room_types.id,  room_types.image,
        ...
        $run_deluxe = mysqli_query($conn,$query_deluxe);
