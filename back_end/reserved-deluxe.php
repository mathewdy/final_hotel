...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Deluxe Rooms</a></li>
        <li class="breadcrumb-item"><a href="executive.php">Executive Rooms</a></li>
    </ol>
    <!--filter-->
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="deluxe.php">Available</a></li>
        <li class="breadcrumb-item active" aria-current="page">Reserved</a></li>
...
WHERE rooms.status = 'reserved' AND room_types.name_of_room = 'deluxe' ";
