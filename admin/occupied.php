...
<body>
   ...
   <?php 
    ...
    LEFT JOIN room_types ON rooms.room_type_id = room_types.id WHERE rooms.status = 'occupied' ORDER BY book_info.added_on DESC";
    ...
    <table>
					...
					<td><a href="details.php?o&rid=<?php echo $rows['room_id']?>&id=<?php echo $rows['users_id']?>">View</a>
					</td>
					</tr>
					</tbody>
					<?php
